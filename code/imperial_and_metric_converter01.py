...
#--
convert_button_color = "goldenrod"
convert_button_text_color = "Black"
...
mile_km_set_button = Button(text="Mile\n&\nKilometer", font=("Arial",10,"bold"), fg=convert_button_text_color, bg="white", background=convert_button_color, width=9, height=4, command=mile_to_km)
mile_km_set_button.place(x=100,y=163)
#
f_c_set_button = Button(text="Fahrenheit\n&\nCelsius", font=("Arial",10,"bold"), fg=convert_button_text_color, bg="white", background=convert_button_color, width=9, height=4, command=f_c)
f_c_set_button.place(x=185,y=163)
#
bdl_kg_set_button = Button(text="Pound\n&\nKilogram", font=("Arial",10,"bold"), fg=convert_button_text_color, bg="white", background=convert_button_color, width=9, height=4, command=lb_kg)
bdl_kg_set_button.place(x=185+85,y=163)
#
gal_l_set_button = Button(text="Gallon\n&\nLiter", font=("Arial",10,"bold"), fg=convert_button_text_color, bg="white", background=convert_button_color, width=9, height=4, command=gal_li)
